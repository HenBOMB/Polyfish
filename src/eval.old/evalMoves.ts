...
//         prevEco = ecoScore;
//         prevArmy = armyScore;
//         if(!undoChain) undos.push(result.undo);
//         else undoChain.push(result.undo);
//     }
...
//             for (const chainMove of result.chainMoves) {
//                 const result = chainMove.execute(state)!;
//                 undoChain.push(result.undo);
//             }
//         }
...
//                 newMoves = [move, ...(result.chainMoves? result.chainMoves : []), ...subBestMove.moves];
//             } else {
//                 score = evaluator(state);
//                 newMoves = [move, ...(result.chainMoves? result.chainMoves : [])];
//             }
//         } else {
//             score = evaluator(state);
//             newMoves = [move, ...(result.chainMoves? result.chainMoves : [])];
...
//         const result = bestTechMove?.execute(state);

//         if(!result) return bestFinalMoves;

//         const undoTech = result.undo;
...
//             const result = capture.execute(state);
//             if(!result) continue;
//             undoChain.push(result.undo);
//         }
//         bestFinalMoves = {
