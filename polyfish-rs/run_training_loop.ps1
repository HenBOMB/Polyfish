...
for ($i = $StartIter; $i -le ($Iterations + $StartIter); $i++) {
    ...
    $AvgCapRuins = $GameJson.avg_cap_ruins
    $AvgCapVillages = $GameJson.avg_cap_villages
    $AvgCapCities = $GameJson.avg_cap_cities
    $AvgCapCapitals = $GameJson.avg_cap_capitals
        ...
        if (Test-Path ".env") {
            ...
            if ($SupabaseUrl -and $SupabaseKey) {
                ...
                $Body = @{
                    ...
                    avg_cap_ruins = (ParseNum $AvgCapRuins)
                    avg_cap_villages = (ParseNum $AvgCapVillages)
                    avg_cap_cities = (ParseNum $AvgCapCities)
                    avg_cap_capitals = (ParseNum $AvgCapCapitals)
