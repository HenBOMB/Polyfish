...
def transfer():
    ...
    if pid == 0:
        ...
        # Check what is in /app and /workspace
        os.write(fd, b"find /app -maxdepth 2 2>/dev/null\n")
        time.sleep(1)
        os.write(fd, b"find /workspace -maxdepth 2 2>/dev/null\n")
        time.sleep(1)
        ...
        with open("remote_output.log", "wb") as f:
            f.write(output)
