...
/// Moved to `ai::movement` (Aug 2026 taxonomy reorg): RIDER_PUSH_MIN_TURNS_SAVED,
/// move_class, turns_to_reach, rider_turns_saved.
pub use crate::ai::movement::{rider_turns_saved, RIDER_PUSH_MIN_TURNS_SAVED};
