...
- **Rate residual**: ~2 games/64 still fail to capture any village within 30 turns. Grade a few failing replays before assuming map geometry explains it.
